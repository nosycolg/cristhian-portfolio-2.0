...
function Dashboard() {
  return (
    <>
      <aside className="z-20 h-full flex lg:flex flex-shrink-0 flex-col w-64 transition-width duration-75">
        <div className="flex-1 flex flex-col min-h-0 border-r border-gray-200 bg-white pt-0">
          <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
            <div className="flex-1 px-3 bg-white divide-y space-y-1">
                ...
                <li>
                  <Link to="/">
                    ...
                    >
                      ...
                      <span className="ml-3">Cristhian Felipe</span>
                    </a>
                  </Link>
                </li>
                <li>
              ...
              <ul className="space-y-2 pt-2">
                <li>
                  <a
                    href="https://profile.indeed.com/p/cristhianf-9jgd8p5"
                    target="_blank"
                    className="text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group cursor-pointer  py-2"
                  >
                    <svg
                      className="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-gray-900 transition duration-75"
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <a
                    href="mailto:cristhianfelipeyt@gmail.com"
                    className="text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group cursor-pointer py-2"
                  >
                    <svg
                      className="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-gray-900 transition duration-75"
